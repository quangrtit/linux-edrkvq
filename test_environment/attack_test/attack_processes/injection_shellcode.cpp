...
/*
sử dung ptrace
1. Attach vào tiến trình mục tiêu (target PID).
2. Đọc thanh ghi để lấy RIP.
3. Backup code gốc tại địa chỉ RIP.
4. Ghi đè shellcode vào RIP.
5. Tiếp tục cho tiến trình chạy → Shellcode sẽ được thực thi.
